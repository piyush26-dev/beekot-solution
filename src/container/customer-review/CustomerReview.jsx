      ...
      <div className="container mx-auto px-6">
        <div className="w-full md:flex block gap-4 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-4 relative">
            ...
            />
            <div className="absolute top-0 left-0  p-2 md:p-4 w-full">
              <div className="flex p-2 md:p-4">
                <div className="flex items-center w-3/5">
                  <div className="rounded-xl h-[6rem] w-[4rem] md:h-[15rem] md:w-[11rem]">
                    <img
                ...
                <div className="w-full md:space-y-4">
                  <div className="w-full relative">
                    ...
                    <div className=" absolute w-[2rem] md:w-[5rem] top-1 right-0 md:right-[2.5rem]">
                      <img src={QuotationIcon} alt="" />
                    </div>
                  </div>
                  <div className="w-full">
                    <p className="font-text text-xs md:text-sm md:font-semibold">
            ...
            <div className="md:hidden flex items-center justify-center gap-4 pt-6">
              <motion.button
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.6 }}
