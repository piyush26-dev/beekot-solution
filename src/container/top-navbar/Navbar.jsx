  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300   ${
        isMenuOpen ? "bg-white shadow-md" : bgClass
      }`}
    >
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="md:hidden flex items-center z-50">
          <button
            ...
            className={`${isMenuOpen ? "text-text-black/70" : "text-white/70"}`}
          >
      ...
      {isMenuOpen && (
        <motion.div
          ...
          animate={{ x: 0 }}
          exit={{ x: "100%" }}
          className="fixed top-0 right-0 w-2/3 h-full bg-white shadow-lg z-40 p-6 flex flex-col gap-6"
        >
          <a
            href="#home"
            className="text-gray-700 hover:text-[#2F6F6F] font-medium dont-text duration-300 transition-all"
